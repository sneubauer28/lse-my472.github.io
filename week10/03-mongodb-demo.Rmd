...
congress <- read.csv("congress-facebook-2017.csv", stringsAsFactors = FALSE)
...
fls <- list.files("posts", full.names=TRUE)
...
dbsql <- dbConnect(RSQLite::SQLite(), "facebook-db.sqlite")
```
